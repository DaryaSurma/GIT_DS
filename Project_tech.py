        ...
        if choose == 1:
            while exit:
                ...
                if choose == 1:
                    ...
                    address = input("Введите адрес нового товара ")
            ...
            while exit:
                ...
                if choose == 1:
                    ...
                    offices.update({name: address})
                elif choose == 2:
                    name = input("Ввести название -> ")
                    if name in offices.keys():
                        new_address = input("Ввести адрес -> ")
                        offices[name]= new_address
                        for element in techs:
                            if techs[element][1] == name:
                                techs[element][0] = new_address
                    else:
                        print("Нет такого офиса.")
                elif choose == 3:
                    name = input("Ввести название -> ")
